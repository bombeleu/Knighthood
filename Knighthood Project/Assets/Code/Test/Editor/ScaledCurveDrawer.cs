...
public class ScaledCurveDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect pos, SerializedProperty prop, GUIContent label)
    {
        ...
        AnimationCurve newCurve = curve.animationCurveValue;
        EditorGUI.CurveField(new Rect(pos.width - curveWidth, pos.y, curveWidth, pos.height), newCurve);
        curve.animationCurveValue = newCurve;
